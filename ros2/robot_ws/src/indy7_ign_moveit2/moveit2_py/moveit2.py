...
class MoveIt2Interface(Node):
    ...
    def __init__(self, separate_gripper_controller: bool = False, use_sim_time: bool = True, node_name: str = 'ign_moveit2_py', robot_model: str = 'indy7', namespace: str = '', prefix: str = '', arm_group_name: Optional[str] = None, gripper_group_name: Optional[str] = None):
    ...
    def init_robot(self, robot_model, separate_gripper_controller, namespace, prefix, arm_group_name, gripper_group_name):
        ...
        """
        if 'indy7' == robot_model:
            self.robot_group_name = "indy7_arm_group"
            # Arm
            self.arm_group_name = "indy7_arm"
            self.arm_joints = [prefix + "indy7_joint1",
                               prefix + "indy7_joint2",
                               prefix + "indy7_joint3",
                               prefix + "indy7_joint4",
                               prefix + "indy7_joint5",
                               prefix + "indy7_joint6"]
            self.arm_links = [prefix + "indy7_link0",
                              prefix + "indy7_link1",
                              prefix + "indy7_link2",
                              prefix + "indy7_link3",
                              prefix + "indy7_link4",
